...
const salasMock = Array.from({ length: 30 }, (_, i) => ({
    ...
    bloco: i % 2 === 0 ? "A" : "B",
    nome: `Sala ${100 + i + 1}`,
    capacidade: Math.floor(Math.random() * 31) + 20, // 20 a 50
    ocupada: Math.random() < 0.5, // true ou false aleatoriamente
}));
...
const Dashboard: React.FC = () => {
    ...
    const salasFiltradas = salasMock.filter((sala) => {
        ...
        <div className={style.dashboard_container}>
            ...
            <div className={style.filtros_container}>
                <div className={style.filtros}>
                    ...
                    <select id="bloco" value={filtroBloco} onChange={(e) => setFiltroBloco(e.target.value)}>
